...
class Hierarchies(PortalLoginService):
    def __init__(self, environment: Environment = None):
        ...
        self.step_definitions = dict()

    def add_step(self, name: str, step: StandardStep):
        self.step_definitions[name] = step

    def __step_call_back(self, name: str, **kwargs):
        step = self.step_definitions.get(name)
        if not step:
    ...
    def get_env_list(self, envs: Envs = None, resp=None, **kwargs):
        ...
        self.__step_call_back(PortalLifeCycle.Name, envs=envs)
    ...
    def get_sponsor(self, path_variable, query: QuerySponsors = None, resp=None, **kwargs):
        ...
        self.__step_call_back(PortalFindSponsor.Name, query=query)
    ...
    def get_study(self, path_variable, data, query: QueryStudies = None, resp=None, **kwargs):
        ...
        self.__step_call_back(PortalFindStudy.Name, query=query)
